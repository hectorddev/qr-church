...
import { Usuario, CrearUsuarioData, ApiResponse } from '@/lib/types';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {showForm && (
          <div className="mb-8 bg-gradient-to-br from-white via-green-50 to-emerald-50 rounded-3xl shadow-2xl border-4 border-green-200 p-6">
            <h2 className="text-2xl font-black text-green-800 mb-6">➕ Crear Nuevo Usuario</h2>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-4 mb-4">
                  <h4 className="font-bold text-blue-800 mb-2">💡 Información importante:</h4>
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>• El <strong>nombre</strong> será usado para el login del usuario</li>
                    <li>• El <strong>versículo ID</strong> será la contraseña del usuario</li>
                    <li>• Los <strong>administradores</strong> pueden editar principios y gestionar usuarios</li>
                    <li>• Los <strong>usuarios</strong> solo pueden ver los principios del camino</li>
                  </ul>
                </div>
        ...
        <div className="bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-3xl shadow-2xl border-4 border-purple-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-black text-purple-800">👥 Usuarios Registrados</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {usuarios.map((usuario) => (
              <div key={usuario.id} className="bg-gradient-to-r from-white to-gray-50 rounded-2xl p-4 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <div className="text-sm text-gray-600">
                  <p><strong>📜 Versículo ID:</strong> {usuario.versiculo_id}</p>
                  <p><strong>📅 Creado:</strong> {new Date(usuario.createdAt).toLocaleDateString()}</p>
                </div>
              </div>
            ))}
          </div>
