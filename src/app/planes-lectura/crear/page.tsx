...
export default function CrearPlanPage() {
    ...
    const agregarCapitulo = () => {
        ...
        // Auto-increment chapter for next entry
    ...
    const crearPlan = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                router.push(`/planes-lectura/${result.data.id}`);
            } else {
        ...
        <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white p-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Ej: Jeremías en 52 días"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Describe el plan de lectura..."
                                    rows={3}
                                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-purple-500 focus:outline-none"
                                />
                            </div>
                            ...
                            <div>
                                <label className="flex items-center gap-3 cursor-pointer">
                                    ...
                                    <span className="text-sm font-semibold text-gray-700">
                                        Hacer este plan público (otros usuarios podrán verlo)
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    {/* Add Chapters */}
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <h2 className="text-2xl font-bold text-gray-800 mb-4">Agregar Capítulos</h2>
                        ...
                        {capitulos.length > 0 && (
                            <div className="mt-6">
                                <h3 className="text-lg font-bold text-gray-800 mb-3">
                                    Vista Previa ({capitulos.length} capítulos)
                                </h3>
                                    ...
                                    {dias.map((dia) => (
                                        <div key={dia} className="border-2 border-gray-200 rounded-lg p-4">
                                            ...
                                            <div className="space-y-2">
                                                {capitulosPorDia[dia].map((cap) => {
                                                    const book = getBookByCode(cap.libro);
                                                    return (
                                                        <div
                                                            key={cap.id}
                                                        ...
                                                        >
                                                            <span className="text-sm">
                                                                {book?.name} {cap.capitulo} ({cap.version})
                                                            </span>
                                                            <button
                    ...
                    <div className="flex gap-4">
                        ...
                        <button
                            onClick={crearPlan}
                            disabled={loading || !titulo || !descripcion || capitulos.length === 0}
